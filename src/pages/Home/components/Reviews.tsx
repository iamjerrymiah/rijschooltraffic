...
const reviews = [
    ...
    },
    {
        ...
        stars: 5,
        content: `
        Echt een aanrader!! Na vele rij-instructeurs te hebben versleten ben ik blij met rijschool Traffic. 
    ...
    },
    {
        ...
        Die RijSchool Traffic door het lesstof gaan met hun leerlingen. Ook hebben zij erg veel geduld met de leerlingen, 
        en zijn erg flexibel met tijden als een bepaald tijdstip jou niet uitkomt. Ik kan mij geen betere rijschool bedenken dan RijSchool Traffic!`
    },
    {
        name: "Chirin Amor",
        stars: 4,
        ...
        <Box py={10} px={[4, 10]}>
            <VStack spacing={2} textAlign="center" mb={8}>
                ...
                <Text fontSize="sm" maxW="800px">
                    Lees hieronder de Google reviews van leerlingen die hun
                    rijbewijs bij ons hebben gehaald.
                </Text>
            </VStack>

            <Box
                overflowX="scroll"
                className="scroll-custom-light"
                bg={"whitesmoke"}
            >
                <Flex gap={6}>
